...
def data():
    ...
    xs=xs[-30:]
    ys=ys[-30:]
    response=make_response(json.dumps(xs))
...
#     global figure, axis
#     plotter.subplots_adjust(hspace=1)
#     axis[0].plot(x_axis, y_axis, label='Attentiveness', color='green', linewidth = 2,marker='o', markerfacecolor='blue', markersize=3)
#     axis[0].plot(ix_axis, iy_axis, label='In-Attentiveness', color='red', linewidth = 2,marker='o', markerfacecolor='blue', markersize=3)
#     axis[0].legend()
    
#     axis[1].plot(x_axis, y_axis, label='Attentiveness', color='green', linewidth = 2,marker='o', markerfacecolor='blue', markersize=3)
#     axis[1].plot(ix_axis, iy_axis, label='In-Attentiveness', color='red', linewidth = 2,marker='o', markerfacecolor='blue', markersize=3)
#     axis[1].legend()
...
#     performance = pie_arr
#     axis[3].bar(y_pos, performance, align='center', alpha=1,color=['yellow', 'red', 'green', 'blue', 'black','cyan'])
#     output = io.BytesIO()
...
#       ax.pie(students, explode=explodeTuple,labels = langs,autopct='%1.2f%%',textprops={'color':"black"})
#       output = io.BytesIO()
#       FigureCanvasSVG(fig2).print_svg(output)
#       finalImg = Response(output.getvalue(), mimetype="image/svg+xml")
#       return finalImg
#       #plot2 = plt.show()
...
# def graph1(): 
#       plt.close()
#       fig3 = plt.figure(facecolor='yellow')
#       #plt.title("Proportionate %age\n" + "of Mood Patterns", bbox={'facecolor':'0.8', 'pad':5})
